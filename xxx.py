...
kk = LINETCR.LINE()
kk.login(token="Em9R3q9VafWrBIh76KQf.BdEnP02hMO6kaNA/dGBjpW.JmEYLSEbg69UYSD9c4gG6LJNJFCkERqLBpZ7MfWnUmo=")
kk.loginResult()

ki = LINETCR.LINE()
ki.login(token="Em6b6om1gTnNEWRDFjOc.G6vbuivi4L1r6SQ3I/CqVa./4mmMODNWi/byExhapOIWGKGRDwV6mo46dTEGtTMo+8=")
ki.loginResult()

kc = LINETCR.LINE()
kc.login(token="EmvoBIBcM3lDTeQJwkB6.CoCVhsgmJMets4WSHPLjbG.Ojs6/syVd9JvV+YLGxMBJyR1j/jv/mwAAqWXfOn6D44=")
kc.loginResult()

ks = LINETCR.LINE()
ks.login(token="Emi5AAnLiNbbaqkjTEm2.kKXu2Gv9Am2FKJ3IiQ4USG.a8OksfiYG3dy984AlKhlki28YpW50+tYoHsUccrBAu8=")
ks.loginResult()

ka = LINETCR.LINE()
ka.login(token="EmF7ErpUg0zKJ7DMFb48.FY1AtMNJibFJOQEPGsBkEa.KCnTg7js2iXgjwjeeDWaI5sMouiSJrSPofU8rsUN8cM=")
ka.loginResult()

kb = LINETCR.LINE()
kb.login(token="EmIs6DHWCgMmO318Pe27.+8d9onRqgdrUF6YcDXJtjW.YuBGJxxV+HL7AYJldjtrY/Tc2gF2mj6woZJxUci9SGs=")
kb.loginResult()

ko = LINETCR.LINE()
ko.login(token="Em1K8FG15ZVTZO09auV5.jpp1P4lfISRvZZpajh6hTq./RoirVYYeKu6bR5jKHwJdKOI6AkKLlac4YyHYvK0Ia0=")
ko.loginResult()

ke = LINETCR.LINE()
ke.login(token="EmVFWGyWziTJvKF9n2Q3.nyyfVvMArNwJVNJ7vTi0GW.jSpYtUgdrgOt3YIWQPd9qf5rC2bAym2dwNF+slNrWMM=")
ke.loginResult()

ku = LINETCR.LINE()
ku.login(token="EmqbGhE8HdRgMfGU6n36.tgx4pSmq7G1roSgev44/XG.vKY3fx6JM+BPZoFYC22ppMtEsYVdK8/KBPMRxFh0z48=")
ku.loginResult()
cl
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,"uf4bdda7a9a6506a04ba6acf087453492"]
admin=["uf4bdda7a9a6506a04ba6acf087453492"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    "dblack":False,
    "clock":False,
    "cName":"¤ป๋า'โหน่ง [Łv.1]",
    "cName2":"¤ป๋า'โหน่ง [Łv.2] ",
    "cName3":"¤ป๋า'โหน่ง [Łv.3] ",
    "cName4":"¤ป๋า'โหน่ง [Łv.4] ",
    "cName5":"¤ป๋า'โหน่ง [Łv.5] ",
    "cName6":"¤ป๋า'โหน่ง [Łv.6] ",
    "cName7":"¤ป๋า'โหน่ง [Łv.7] ",
    "cName8":"¤ป๋า'โหน่ง [Łv.8] ",
    "cName9":"¤ป๋า'โหน่ง [Łv.9] ",
    "cName10":"¤ป๋า'โหน่ง [Łv.10]",
    "blacklist":{},
    "wblacklist":False,
    "dblacklist":False,
    "Protectgr":False,
